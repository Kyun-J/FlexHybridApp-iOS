...
Pod::Spec.new do |spec|
  ...
  spec.source_files = "flexhybridapp/**/*.{swift,xib}"
  # spec.vendored_frameworks = "FlexHybridApp.framework"
  ...
  # Or just: spec.author    = "Kyun-J"
  # spec.authors            = { "Kyun-J" => "dvkyun@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Kyun-J"
